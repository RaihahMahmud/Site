...
const stats = [
  { value: 'NSU', label: 'BSc CSE · 2022–2027' },
  { value: '2026', label: 'FlyRank ML Intern' },
  { value: '498R', label: 'Bengali NLP research' },
  { value: 'CSE299', label: 'Easy-Ben Explanator' },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="space-y-4 text-dim font-body leading-relaxed" style={{ fontSize: '16px' }}>
              <p>
                I'm a Computer Science undergraduate at North South University in Dhaka.
                I build practical software and machine-learning systems — from full-stack
                web products to applied NLP for low-resource languages.
              </p>
              <p>
