  ...
  return (
    ...
    >
      <div className={`mx-auto max-w-6xl px-6 flex items-center justify-between transition-all duration-500 ${
        ...
        <a href="#home" className="font-mono text-sm font-medium text-paper hover:text-acid transition-colors">
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="md:hidden glass border-t border-paper/5 px-6 py-6 flex flex-col gap-4 overflow-hidden"
          >
            {navItems.map(item => (
              <a
                key={item.label}
            ...
            <a
              href="mailto:raihankhmahmud@gmail.com"
              onClick={() => setMenuOpen(false)}
              className="font-mono text-sm text-acid"
            >
              Hire Me
            </a>
          </motion.div>
